...
def train_model(model, dataloaders, criterion, optimizer, name_model, num_epochs=25, is_inception=False):
    ...
    for epoch in range(num_epochs):
        ...
        for phase in ['Val','Train']:
            ...
            if phase == 'Train':
                ...
                with open(name_model+ '_train_loss' + ".txt", "a") as myfile:
            ...
            if phase == 'Val':
                ...
                with open(name_model+ '_val_loss' + ".txt", "a") as myfile:
                    myfile.write(str(epoch_loss)+"\n")
    ...
    return model, val_acc_history, train_loss, val_loss, train_acc, model_last_wts
